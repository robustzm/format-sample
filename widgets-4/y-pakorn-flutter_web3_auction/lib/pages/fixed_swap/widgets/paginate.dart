  ...
  Widget build(BuildContext context) {
    ...
    return [
      if (!h.pageController.isFirstPage) ...[
        'first'.text().textDecoration(TextDecoration.underline).niku().padding(
          EdgeInsets.symmetric(horizontal: 5),
        ).scale().onTap(
          h.isLoadingItem
              ? null
