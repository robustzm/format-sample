                      ...
                      IconButton(
                        ...
                        icon: StreamBuilder(
                          ...
                          builder: (
                            ...
                            Color iconColor = new Color(colors[1]).withOpacity(
                              .5,
                            );
                            IconData iconToBe = Icons.repeat;
                            if (snapshot.hasData) {
                              bool isSongRepeat = snapshot.data.contains(
                                Playback.repeatSong,
                              );
                              bool isQueueRepeat = snapshot.data.contains(
                            ...
                            return Icon(iconToBe, color: iconColor, size: 15);
                          },
                        ),
                        onPressed: () {
