...
class MockAudioProvider extends _i1.Mock implements _i4.AudioProvider {
  ...
  @override
  _i2.AssetsAudioPlayer get player => (super.noSuchMethod(
    Invocation.getter(#player),
    returnValue: _FakeAssetsAudioPlayer(),
  ) as _i2.AssetsAudioPlayer);
  @override
  List<_i5.Song> get queuedSongs => (super.noSuchMethod(
    Invocation.getter(#queuedSongs),
    returnValue: <_i5.Song>[],
  ) as List<_i5.Song>);
  @override
  _i3.ValueStream<_i2.PlayerState> get playerState => (super.noSuchMethod(
  ...
  @override
  _i6.Future<bool> queued(_i5.Song? song) => (super.noSuchMethod(
    Invocation.method(#queued, [song]),
    returnValue: Future<bool>.value(false),
  ) as _i6.Future<bool>);
  @override
  _i6.Future<int> indexInQueue(_i5.Song? song) => (super.noSuchMethod(
    Invocation.method(#indexInQueue, [song]),
    returnValue: Future<int>.value(0),
  ) as _i6.Future<int>);
  @override
  _i6.Future<void> play({_i5.Song? song}) => (super.noSuchMethod(
  ...
  @override
  _i6.Future<int> queueToTop({_i5.Song? song}) => (super.noSuchMethod(
    Invocation.method(#queueToTop, [], {#song: song}),
    returnValue: Future<int>.value(0),
  ) as _i6.Future<int>);
  @override
  _i6.Future<int> queueToBottom({_i5.Song? song}) => (super.noSuchMethod(
    Invocation.method(#queueToBottom, [], {#song: song}),
    returnValue: Future<int>.value(0),
  ) as _i6.Future<int>);
  @override
  ...
  @override
  _i6.Future<bool> playNext() => (super.noSuchMethod(
  ...
  @override
  void reorderQueue(int? oldIndex, int? newIndex) => super.noSuchMethod(
    Invocation.method(#reorderQueue, [oldIndex, newIndex]),
    returnValueForMissingStub: null,
  );
  @override
  _i6.Future<void> cleanUpUponLogout() => (super.noSuchMethod(
...
class MockAppRouter extends _i1.Mock implements _i8.AppRouter {
  ...
  @override
  _i6.Future<void> gotoAlbumDetailsScreen(
    _i9.BuildContext? context, {
    _i10.Album? album,
  }) => (super.noSuchMethod(
    Invocation.method(#gotoAlbumDetailsScreen, [context], {#album: album}),
    returnValue: Future<void>.value(),
    returnValueForMissingStub: Future<void>.value(),
  ) as _i6.Future<void>);
  @override
  _i6.Future<void> gotoArtistDetailsScreen(
    _i9.BuildContext? context, {
    _i11.Artist? artist,
  }) => (super.noSuchMethod(
    Invocation.method(#gotoArtistDetailsScreen, [context], {#artist: artist}),
    returnValue: Future<void>.value(),
    returnValueForMissingStub: Future<void>.value(),
  ) as _i6.Future<void>);
  @override
  ...
  @override
  _i6.Future<void> showCreatePlaylistSheet(_i9.BuildContext? context) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> showActionSheet(
    _i9.BuildContext? context, {
    _i5.Song? song,
  }) => (super.noSuchMethod(
