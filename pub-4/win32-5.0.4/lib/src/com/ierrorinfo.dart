...
class IErrorInfo extends IUnknown {
  ...
  factory IErrorInfo.from(IUnknown interface) => IErrorInfo(
    interface.toInterface(IID_IErrorInfo),
  );

  int getGUID(Pointer<GUID> pGUID) => ptr.ref.vtable.elementAt(3).cast<
    Pointer<NativeFunction<Int32 Function(Pointer, Pointer<GUID> pGUID)>>
  >().value.asFunction<int Function(Pointer, Pointer<GUID> pGUID)>()(
    ptr.ref.lpVtbl,
    pGUID,
  );
  ...
  int getDescription(Pointer<Pointer<Utf16>> pBstrDescription) => ptr.ref.vtable
      ...
      .cast<
        Pointer<
          NativeFunction<
            Int32 Function(Pointer, Pointer<Pointer<Utf16>> pBstrDescription)
          >
        >
      >()
      .value
  ...
  ) => ptr.ref.vtable.elementAt(7).cast<
    Pointer<
      NativeFunction<Int32 Function(Pointer, Pointer<Uint32> pdwHelpContext)>
    >
  >().value.asFunction<int Function(Pointer, Pointer<Uint32> pdwHelpContext)>()(
    ptr.ref.lpVtbl,
    pdwHelpContext,
  );
}
