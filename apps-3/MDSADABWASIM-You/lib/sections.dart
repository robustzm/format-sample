...
final List<Section> allSections = <Section>[
  Section(
    ...
    details: <SectionDetail>[
      ...
      _googleDetail(
        ...
        'Google knows your location details',
        ' your location history',
      ),
      _googleDetail(
        'https://myactivity.google.com/myactivity',
        "Google  records, what you are searching",
      ...
      _googleDetail(
        ...
        'See who are using your account',
        "your account login devices",
      ),
      _googleDetail(
  ...
  Section(
    ...
    details: <SectionDetail>[
      ...
      _facebookDetail(
        ...
        'Facebook knows what are you doing',
        'Check  your activity',
      ),
      _facebookDetail(
  ...
  const Section(
    ...
    details: const <SectionDetail>[_instagramImageDetail, _instagramDetail],
  ),
  const Section(
    title: 'TWITTER',
    leftColor: _mariner,
    ...
    details: const <SectionDetail>[_twitterImageDetail, _twitterDetail],
  ),
];
