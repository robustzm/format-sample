      ...
      builder: (context, usersnapshot) {
        requestedToJoin = usersnapshot.hasData
            ? usersnapshot.data['currentGroupJoinRequests'] != null &&
                usersnapshot.data['currentGroupJoinRequests'].contains(
                  widget.docId,
                )
            : false;
        if (usersnapshot.connectionState == ConnectionState.active) {
          ...
          return StreamBuilder(
            stream: Firestore.instance.collection('group').document(
              widget.docId,
            ).snapshots(),
            builder: (context, groupsnapshot) {
              if (groupsnapshot.connectionState == ConnectionState.active) {
                ...
                start = DateFormat('dd.MM.yyyy - kk:mm a').format(
                  groupsnapshot.data['start'].toDate(),
                );
                end = DateFormat('dd.MM.yyyy - kk:mm a').format(
                  groupsnapshot.data['end'].toDate(),
                );
                              ...
                              child: StreamBuilder(
                                ...
                                builder: (ctx, futureSnapshot) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount:
                                        futureSnapshot.data.documents.length,
                                                    ...
                                                    try {
                                                      if (Platform.isIOS) {
                                                        await Clipboard.setData(
                                                          ClipboardData(
                                                            text: '${futureSnapshot.data.documents[
                                                                  index
                                                                ].data[
                                                                  'mobilenum'
                                                                ].toString()}',
                                                        ...
                                                        await launch(
                                                          'tel://${futureSnapshot.data.documents[
                                                                index
                                                              ].data[
                                                                'mobilenum'
                                                              ].toString()}',
                                    ...
                                    TextButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        try {
                                          ...
                                          GroupDetails.inGroup = true;
                                          await _notifServices.groupJoin(
