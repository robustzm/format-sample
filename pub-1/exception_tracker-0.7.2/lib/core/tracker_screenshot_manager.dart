...
import 'package:exception_tracker/utils/tracker_logger.dart';
...
class TrackerScreenshotManager {
  final TrackerLogger _logger;
  late GlobalKey _containerKey;
  String? _path;

  TrackerScreenshotManager(this._logger) {
