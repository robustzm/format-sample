...
class AppinioSocialShare {
  ...
  Future<String> shareToWhatsapp(String message, {String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToWhatsapp(
      message,
      filePath: filePath,
    );
  }
  ...
  Future<String> shareToTelegram(String message, {String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToTelegram(
      message,
      filePath: filePath,
    );
  }
  ...
  Future<String> shareToTwitter(String message, {String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToTwitter(
      message,
      filePath: filePath,
    );
  }
  ...
  Future<String> shareToSystem(
    ...
    return AppinioSocialSharePlatform.instance.shareToSystem(
      title,
      message,
      filePath: filePath,
    );
  ...
  Future<String> shareToSMS(String message, {String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToSMS(
      message,
      filePath: filePath,
    );
  }
