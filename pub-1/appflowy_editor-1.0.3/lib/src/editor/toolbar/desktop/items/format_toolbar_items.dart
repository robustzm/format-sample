...
final List<ToolbarItem> markdownFormatItems = [
  _FormatToolbarItem(
    ...
    name: 'underline',
    tooltip:
        '${AppFlowyEditorLocalizations.current.underline}${shortcutTooltips(
      '⌘ + U',
      'CTRL + U',
      'CTRL + U',
    )}',
  ...
  _FormatToolbarItem(
    id: 'editor.bold',
    name: 'bold',
    tooltip: '${AppFlowyEditorLocalizations.current.bold}${shortcutTooltips(
      '⌘ + B',
      'CTRL + B',
      'CTRL + B',
    )}',
  ...
  _FormatToolbarItem(
    ...
    name: 'strikethrough',
    tooltip:
        '${AppFlowyEditorLocalizations.current.strikethrough}${shortcutTooltips(
      '⌘ + SHIFT + S',
      'CTRL + SHIFT + S',
      'CTRL + SHIFT + S',
    )}',
  ...
  _FormatToolbarItem(
    ...
    name: 'code',
    tooltip:
        '${AppFlowyEditorLocalizations.current.embedCode}${shortcutTooltips(
      '⌘ + E',
      'CTRL + E',
      'CTRL + E',
    )}',
