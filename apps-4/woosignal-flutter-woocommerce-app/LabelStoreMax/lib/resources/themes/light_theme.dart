...
ThemeData lightTheme() {
  TextTheme lightTheme = getAppTextTheme(
    appThemeFont,
    defaultTextTheme.merge(_lightTextTheme()),
  );
  ...
  return ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle: lightTheme.headline6.copyWith(
        color: NyColors.light.appBarPrimaryContent,
      ),
    ...
    textSelectionTheme:
        TextSelectionThemeData(cursorColor: NyColors.light.inputPrimaryContent),
  );
}
...
TextTheme _lightTextTheme() {
  final Color lightPrimaryContent = NyColors.light.primaryContent;
  return TextTheme(
    headline6: TextStyle(color: lightPrimaryContent),
    headline5: TextStyle(color: lightPrimaryContent),
    headline4: TextStyle(color: lightPrimaryContent),
    headline3: TextStyle(color: lightPrimaryContent),
    headline2: TextStyle(color: lightPrimaryContent),
    headline1: TextStyle(color: lightPrimaryContent),
    subtitle2: TextStyle(color: lightPrimaryContent),
    subtitle1: TextStyle(color: lightPrimaryContent),
    overline: TextStyle(color: lightPrimaryContent),
    button: TextStyle(color: lightPrimaryContent.withOpacity(0.8)),
    bodyText2: TextStyle(color: lightPrimaryContent.withOpacity(0.8)),
    bodyText1: TextStyle(color: lightPrimaryContent),
    caption: TextStyle(color: lightPrimaryContent),
  );
}
