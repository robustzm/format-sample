...
String chatMessageModelToJson(List<ChatMessageModel> data) => json.encode(
  List<dynamic>.from(data.map((x) => x.toJson())),
);

ChatMessageModel sendMessageModelFromJson(
  String str,
) => ChatMessageModel.fromJson(json.decode(str));

String sendMessageModelToJson(ChatMessageModel data) => json.encode(
  data.toJson(),
);
...
class ChatMessageModel {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "mediaChatMessage": mediaChatMessage == null
        ? null
        : mediaChatMessage!.toJson(),
    "locationChatMessage": locationChatMessage == null
        ? null
...
class ContactChatMessage {
  ...
  factory ContactChatMessage.fromJson(
    Map<String, dynamic> json,
  ) => ContactChatMessage(
...
class LocationChatMessage {
  ...
  factory LocationChatMessage.fromJson(
    Map<String, dynamic> json,
  ) => LocationChatMessage(
...
class MediaChatMessage {
  ...
  factory MediaChatMessage.fromJson(
    Map<String, dynamic> json,
  ) => MediaChatMessage(
...
class MessageStatus {
  MessageStatus({required this.status});
...
class ReplyParentChatMessage {
  ...
  factory ReplyParentChatMessage.fromJson(
    Map<String, dynamic> json,
  ) => ReplyParentChatMessage(
    chatUserJid: json["chatUserJid"],
    isMessageDeleted: json["isMessageDeleted"],
