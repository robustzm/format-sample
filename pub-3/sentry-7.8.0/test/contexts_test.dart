...
void main() {
  ...
  group('parse contexts', () {
    test('should parse json context', () {
      ...
      expect(MapEquality().equals(contexts.operatingSystem!.toJson(), {
        'build': '19H2',
        'rooted': false,
        'kernel_version':
      ...
      expect(MapEquality().equals(contexts.device!.toJson(), {
        'simulator': true,
        'model_id': 'simulator',
        'arch': 'x86',
      ...
      expect(MapEquality().equals(contexts.app!.toJson(), {
      ...
      expect(MapEquality().equals(contexts.runtimes.first.toJson(), {
        'name': 'testRT1',
        'version': '1.0',
        'raw_description': 'runtime description RT1 1.0',
      }), true);
      expect(MapEquality()
          .equals(contexts.browser!.toJson(), {'version': '12.3.4'}), true);
      expect(MapEquality().equals(contexts.gpu!.toJson(), {
        'name': 'Radeon',
        'version': '1',
      }), true);
    });
